    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
                <?php echo form_open('backend/productcategories/update') ?>
                    <input type="hidden" name="id" value="<?= $record['id'] ?>">
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <small class="font-weight-bold">Nama Kategori</small>
                            <input type="text" name="category_name" id="category_name" class="form-control form-control-sm" value="<?= $record['category_name'] ?>">
                        </div>
                    </div>
